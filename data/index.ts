...
export const gridItems = [
  {
    ...
    description: "",
    className: "md:col-span-6 md:min-h-[40vh] lg:col-start-1 lg:col-span-4 lg:row-start-1 lg:row-span-3 lg:min-h-[60vh]",
  ...
  },
  {
    ...
    description: "",
    className: "md:col-span-3 md:min-h-[15rem] lg:col-start-5 lg:col-span-2 lg:row-start-1 lg:row-span-2",
    imgClassName: "",
  ...
  },
  {
    ...
    title: "My tech stack",
    description: "",
    className: "md:col-span-3 md:row-span-2 lg:col-start-5 lg:col-span-2 lg:row-start-3 lg:row-span-2",
    imgClassName: "",
    titleClassName: "justify-start",
    img: "",
    spareImg: "",
  },
  {
    ...
    description: "",
    className: "md:col-span-3 lg:col-start-1 lg:col-span-4 lg:row-start-4",
    imgClassName: "",
    titleClassName: "justify-start",
    img: "/grid.svg",
    spareImg: "/b4.svg",
...

  {
    ...
    className: "md:col-span-3 lg:col-start-1 lg:col-span-2 lg:row-start-5",
    imgClassName: "absolute right-0 bottom-0 w-60 md:w-72 lg:w-64 opacity-30",
  ...
  },
  {
    ...
    description: "",
    className: "md:col-span-3 lg:col-start-3 lg:col-span-4 lg:row-start-5",
    imgClassName: "",
...
export const workExperience = [
  {
    id: 1,
    title: "BCS Student — Carleton University",
    desc: "Pursuing a Bachelor of Computer Science at Carleton University after completing a Computer Programming Diploma at Algonquin College in April 2026.",
